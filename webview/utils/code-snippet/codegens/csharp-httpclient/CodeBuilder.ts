class CodeBuilder {
   ...
   */
  constructor(indentSize: number, indentCharacter: string) {
   ...
   */
  build(addUsings?: boolean): string {
    if (addUsings) {
